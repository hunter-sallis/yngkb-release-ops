window.ReleaseOps.register("rockstar-lifestyle", "post", {
  days: [
    ...
    { day: 3, date: "2026-10-05", title: "Momentum check", tasks: [
      ...
      { id: "pr3-profiles", t: "Claim Amazon and TIDAL profiles; decide on DistroVid", owner: "Artist", status: "pending" }
    ]},
    { day: 7, date: "2026-10-09", title: "First week", tasks: [
      ...
      { id: "pr7-apple", t: "Claim Apple Music for Artists (five business days live) and the YouTube Official Artist Channel", owner: "Artist", status: "pending" },
      { id: "pr7-sx", t: "Register the recording at SoundExchange and the composition at The MLC", owner: "Keyman", status: "pending" }
    ]},
    { day: 14, date: "2026-10-16", title: "Second week", tasks: [
      ...
      { id: "pr14-recon", t: "Metadata reconciliation across DistroKid, PRO, MLC and store credits", owner: "Keyman", status: "pending" }
    ]},
    { day: 28, date: "2026-10-30", title: "Momentum decision", tasks: [
      ...
      { id: "pr28-royalty", t: "First royalty-verification sweep: is the release represented everywhere it earns?", owner: "Keyman", status: "pending" }
    ]}
  ],
