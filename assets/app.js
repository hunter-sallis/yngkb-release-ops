...
(function () {
  ...
  function renderPR() {
    ...
    const tracker = `<h4>Firm tracker — ranked by fit</h4><p class="sm" style="margin:0 0 6px">Lead = the firm already approached. Tier 1 = inside the Future / Roc Nation / CMG orbit. Tier 2 = deepest street-rap rosters and the realistic doors for a debut single.  Every channel is a link; emails open a draft, phone numbers dial.</p>
